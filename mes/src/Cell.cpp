...
void Cell::process() { return; }

void Cell::updateQueue() { return; }

void Cell::updateAction() { return; }
...
void ProductionCell::process(uint8_t bUnit, uint8_t fUnit) {
  ...
  if (((bUnit == 1) && (fUnit == 2)) || ((bUnit == 1) && (fUnit == 4)) ||
      ((bUnit == 1) && (fUnit == 7)) || ((bUnit == 5) && (fUnit == 6)) ||
      ((bUnit == 9) && (fUnit == 5)) || ((bUnit == 2) && (fUnit == 3)) ||
      ((bUnit == 4) && (fUnit == 5)) || ((bUnit == 2) && (fUnit == 5)) ||
      ((bUnit == 7) && (fUnit == 8)) || ((bUnit == 8) && (fUnit == 9))) {

    singleOperation(bUnit, fUnit);
  }

  else if (((bUnit == 1) && (fUnit == 3)) || ((bUnit == 1) && (fUnit == 5)) ||
           ((bUnit == 4) && (fUnit == 6)) || ((bUnit == 1) && (fUnit == 5)) ||
           ((bUnit == 1) && (fUnit == 8)) || ((bUnit == 2) && (fUnit == 6)) ||
           ((bUnit == 8) && (fUnit == 5))) {

    multipleOperation(bUnit, fUnit);
  }

  else if (((bUnit == 9) && (fUnit == 6)) || ((bUnit == 7) && (fUnit == 9))) {
    sameMachineOperation(bUnit, fUnit);
  }

  else if (((bUnit == 1) && (fUnit == 6)) || ((bUnit == 1) && (fUnit == 9)) ||
           ((bUnit == 7) && (fUnit == 5)) || ((bUnit == 8) && (fUnit == 6)) ||
           ((bUnit == 7) && (fUnit == 6))) {
  ...
  if ((type == 1) || (type == 3)) {
    ...
    if (RE(OPCUA_readBool(client, sf), type)) { // RE 1 and 3
      if (machineOpQueueBC.front()) {
        ...
        if ((availability & ~0xFFF7) &&
            (availability & ~0xFFFB)) { // 1000 & 0100 - 1st and 2nd Free
          ...
          toolTimeQueueBC.pop();
        } else if (!(availability & ~0xFFF7) &&
                   (availability & ~0xFFFB)) { // !1000 & 0100 - 1st Free
  ...
  // Select Machine A in Cell 2 and 4
    ...
    if (RE(OPCUA_readBool(client, sf), type)) { // RE 2 and 4
      if (machineOpQueueA.front()) {
        ...
        if ((((availability & ~0xFFFB) && (availability & ~0xFFFD)) || wait) &&
            !doubleOpD.front()) { // 0100 & 0010 - 1st and 2nd Free
          machineOpQueueAB1.push(false);
          machineOpQueueAB2.push(true);
